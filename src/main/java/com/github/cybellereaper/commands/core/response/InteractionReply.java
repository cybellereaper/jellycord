...
public final class InteractionReply implements CommandResponse {
    ...
    public static Builder create() { return new Builder(ResponseMode.REPLY); }
    public static Builder ephemeral() { return new Builder(ResponseMode.REPLY).ephemeral(true); }
    public static Builder updateMessage() { return new Builder(ResponseMode.UPDATE_MESSAGE); }
    public static Builder deferReply() { return new Builder(ResponseMode.DEFER_REPLY); }
    public static Builder deferUpdate() { return new Builder(ResponseMode.DEFER_UPDATE); }
    public static Builder followup() { return new Builder(ResponseMode.FOLLOWUP); }
    public static Builder editOriginal() { return new Builder(ResponseMode.EDIT_ORIGINAL); }

    public ResponseMode mode() { return mode; }
    public String content() { return content; }
    public boolean isEphemeral() { return ephemeral; }
    public List<EmbedSpec> embeds() { return embeds; }
    public List<ActionRowSpec> components() { return components; }
    ...
    public static final class Builder {
        ...
        private Builder(ResponseMode mode) { this.mode = mode; }
        ...
        public Builder embed(EmbedSpec value) { this.embeds.add(value); return this; }
        public Builder embeds(List<EmbedSpec> value) { this.embeds.addAll(value); return this; }
        public Builder components(ActionRowSpec... rows) { this.components.addAll(List.of(rows)); return this; }
        public Builder components(List<ActionRowSpec> rows) { this.components.addAll(rows); return this; }
