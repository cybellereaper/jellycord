package com.github.cybellereaper.commands.core.response.embed;

public record EmbedSpec(String title, String description, Integer color, String url, String imageUrl, String thumbnailUrl) {
    ...
    public static final class Builder {
        ...
        public Builder color(Integer value) { this.color = value; return this; }
        public Builder url(String value) { this.url = value; return this; }
        public Builder imageUrl(String value) { this.imageUrl = value; return this; }
        public Builder thumbnailUrl(String value) { this.thumbnailUrl = value; return this; }
