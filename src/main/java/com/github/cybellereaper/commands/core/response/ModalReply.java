...
public final class ModalReply implements CommandResponse {
    ...
    public List<ModalField> fields() { return fields; }
    ...
    public static final class Builder {
        ...
        private Builder(String customId) { this.customId = customId; }
        ...
        public ModalReply build() { return new ModalReply(customId, title, fields); }
    }
